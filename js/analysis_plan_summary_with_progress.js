...
function get_plan(from_month,from_year,to_month,to_year,access_type,access_type_val,ana_sector) {
		...
		//alert(apipath+'get_plan?anaProgram='+anaProgram+'&anaProject='+anaProject+'&from_month='+from_month+'&from_year='+from_year+'&to_month='+to_month+'&to_year='+to_year+'&sector='+ana_sector);
				
			$.ajax({				   
					url:apipath+'get_plan?access_type='+access_type+'&access_type_val='+access_type_val+'&from_month='+from_month+'&from_year='+from_year+'&to_month='+to_month+'&to_year='+to_year+'&sector='+ana_sector,
...
function get_achivement(from_month,from_year,to_month,to_year,access_type,access_type_val,ana_sector){
	//alert(apipath+'get_achievement?anaProject='+anaProject+'&from_month='+from_month+'&from_year='+from_year+'&to_month='+to_month+'&to_year='+to_year+'&sector='+ana_sector);
	$.ajax({				   
		url:apipath+'get_achievement?access_type='+access_type+'&access_type_val='+access_type_val+'&from_month='+from_month+'&from_year='+from_year+'&to_month='+to_month+'&to_year='+to_year+'&sector='+ana_sector,
			  success: function(result) {
				  ach_list=result;
				  $('#ach_text').val(result);
				  compare_data()
