...
function get_plan(from_month,from_year,to_month,to_year,anaPngo) {
		//alert(apipath+'get_plan_details?anaPngo='+anaPngo+'&from_month='+from_month+'&from_year='+from_year+'&to_month='+to_month+'&to_year='+to_year);			
			$.ajax({				   
					url:apipath+'get_plan_details?anaPngo='+anaPngo+'&from_month='+from_month+'&from_year='+from_year+'&to_month='+to_month+'&to_year='+to_year,
...
function get_achivement(from_month,from_year,to_month,to_year,anaPngo){	
	$.ajax({				   
		url:apipath+'get_achievement_details?anaPngo='+anaPngo+'&from_month='+from_month+'&from_year='+from_year+'&to_month='+to_month+'&to_year='+to_year,
			  success: function(result) {
				  ach_list=result;
				  $('#ach_text').val(result);
				  compare_data()
...
function compare_data() {
	...
	for(i=0;i<plan_list_count;i++){
		...
		plan_ach_array[i][3]=plan_array[3]; //Sector
