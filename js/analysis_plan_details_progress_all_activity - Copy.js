...
function get_plan(from_month,from_year,to_month,to_year,anaPngo) {
		//alert(apipath+'get_plan_details_all_activity?anaPngo='+anaPngo+'&from_month='+from_month+'&from_year='+from_year+'&to_month='+to_month+'&to_year='+to_year);			
			$.ajax({				   
					url:apipath+'get_plan_details_all_activity?anaPngo='+anaPngo+'&from_month='+from_month+'&from_year='+from_year+'&to_month='+to_month+'&to_year='+to_year,
...
function get_achivement(from_month,from_year,to_month,to_year,anaPngo){		
	$.ajax({				   
		url:apipath+'get_achievement_details_all_activity?anaPngo='+anaPngo+'&from_month='+from_month+'&from_year='+from_year+'&to_month='+to_month+'&to_year='+to_year,
			  success: function(result) {
				  ach_list=result;
				  $('#ach_text').val(result);
				  compare_data()
